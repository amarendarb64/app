...
<br><br><br><br><br><br>
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form:form class="form-login" action="signUpValidation" method="post" commandName="SignUp">
		        <h2 class="form-login-heading">SignUp Now 	</h2>
		           <center> <span>${message}</span></center>
		        <div class="login-wrap">
		            <input type="text" class="form-control-login" id="userName" name="userName" placeholder="UserName" onchange="checkUserName()" autofocus>
		            <br>
		            <input type="date" class="form-control-login"  name="dob" placeholder="DOB">
